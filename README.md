...
- 스니커즈 제품 특성상 다양한 요인이 거래 가격에 영향을 미침 -> 단순 수익성, 변동성만을 변수로 묶어 투자 가치를 판단하기엔 어려움이 있음

개선방안
- 군집 분석에서 더 나아가 상품의 개별 특성, 시간적, 추세적 요소를 고려하여 수익성을 판단하고 예측을 진행한다면 상품의 투자 가치에 대한 좀 더 상세하고 의미 있는 결과를 도출할 수 있을 것이라 예상함
