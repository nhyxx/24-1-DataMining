...
|이걸안사? (군집 1)|높은 수익률, 높은 거래량, 높은 변동성|
|갖고싶으면사 (군집 2)|낮은 수익률, 중간 거래량, 중간 변동성|
|나는스릴을즐긴다 (군집 3)|높은 수익률, 중간 거래량, 매우 높은 변동성|
|나같으면그냥신음 (군집 4)|낮은 수익률, 낮은 거래량, 낮은 변동성성|
